...
const LogoDark = ({ size = 140 }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1171.77 189.84" width={size} height={size * 189.84 / 1171.77}>
    ...
    <path fill="#111111" d="M734.71,329.72h36.4V513.17h-36.4Z" transform="translate(-429.42 -326.25)"/>
    <path fill="#111111" d="M813.31,329.72h62.41a104.13,104.13,0,0,1,26.59,3.33,59.53,59.53,0,0,1,22,10.54,46.85,46.85,0,0,1,14.74,18.78Q944,373.62,944,389.24q0,15.9-4.91,27a49.43,49.43,0,0,1-14.81,18.93,59.45,59.45,0,0,1-22.1,10.26,107.62,107.62,0,0,1-26.44,3.32h-26v64.42H813.31ZM869.66,421a74.9,74.9,0,0,0,15.6-1.31,30,30,0,0,0,11-5.05,26.85,26.85,0,0,0,8.38-10.11q2.88-6.09,2.88-15.32,0-9-2.88-15a26.69,26.69,0,0,0-8.38-10.11,28.91,28.91,0,0,0-10.84-5.21A66.91,66.91,0,0,0,870,357.48H849.7v63.57Z" transform="translate(-429.42 -326.25)"/>
    <path fill="#111111" d="M988.53,508.57q-18.35-7.51-30.48-20.22l18.49-25.43a88.82,88.82,0,0,0,12.14,9.82,81.84,81.84,0,0,0,17.19,9,54.48,54.48,0,0,0,19.79,3.76q16.17,0,24.7-6t8.53-16.71q0-9-6.07-14a56.6,56.6,0,0,0-14.74-8.42c-1.33-.39-3.31-1.12-5.92-2.19s-6-2.38-10.26-3.92q-5.49-2.31-10.54-4.05c-3.38-1.16-6.12-2.22-8.24-3.19q-20.22-8.69-28.89-21.73-7.51-11-7.51-26.07a50.74,50.74,0,0,1,5-22.16A48.48,48.48,0,0,1,986.94,339q17-12.75,45.65-12.74a86,86,0,0,1,25,3.61,96.76,96.76,0,0,1,21.09,8.95,73.18,73.18,0,0,1,14.63,10.84l-15.6,24.85q-7.23-7.8-19.8-13.58a61.18,61.18,0,0,0-25.9-5.76q-14.44,0-22.1,5.39t-7.6,15.28a15.61,15.61,0,0,0,3.41,10.33,27,27,0,0,0,7.66,6.52,88.84,88.84,0,0,0,10,4.63l15,5.8q17.32,6,19.93,7.49,19.35,8.7,28,21.16,8.39,11.88,8.38,28.1a51.75,51.75,0,0,1-3.32,18,52.4,52.4,0,0,1-10,16.51q-8.62,9.78-22.63,15.79t-33.08,5.93A97.21,97.21,0,0,1,988.53,508.57Z" transform="translate(-429.42 -326.25)"/>
    <path fill="#111111" d="M1157,504.93q-19.79-11.16-31.2-32.76T1114.36,421q0-29.28,12.28-50.72t32.5-32.75a89.13,89.13,0,0,1,44.17-11.29q20.81,0,35.54,7.1t22,14.34q7.22,7.24,9.53,11.3l-19.07,24a43.76,43.76,0,0,0-9.82-11.56,56.34,56.34,0,0,0-16-9.58,53.43,53.43,0,0,0-20.37-3.81q-15.88,0-28,7.69a51.41,51.41,0,0,0-18.93,21.92q-6.89,14.2-6.88,32.79t6.65,32.8a51.82,51.82,0,0,0,18.63,22.06q12,7.85,27.88,7.83a53.49,53.49,0,0,0,20.37-3.94,63.09,63.09,0,0,0,16.62-9.74,53.36,53.36,0,0,0,10.69-11.56l18.78,24.56q-4.64,7.83-14.16,15.65a79.13,79.13,0,0,1-23.69,12.9,92.28,92.28,0,0,1-31.21,5.07Q1176.76,516.08,1157,504.93Z" transform="translate(-429.42 -326.25)"/>
    <path fill="#111111" d="M1297,329.72h117.88v28.61h-81.48v44.49h75.7v28.9h-75.7v52h84.08v29.45H1297Z" transform="translate(-429.42 -326.25)"/>
    <path fill="#111111" d="M1449.51,329.72h39L1566.81,456V329.72h34.38V513.17h-35l-82.35-132.9v132.9h-34.33Z" transform="translate(-429.42 -326.25)"/>
    <rect fill="#d71920" y="3.46" width="36.41" height="183.47"/>
    <polygon fill="#d71920" points="138.53 186.93 138.53 186.93 50.52 95.19 138.53 3.46 138.53 3.46 138.53 186.93"/>
  </svg>
)
...
function MainApp({ session }) {
  ...
  if (isLoading) return (
    <div style={{ display: 'flex', height: '100vh', background: '#f5f5f5', overflow: 'hidden' }}>
      <div style={{ width: '220px', background: 'white', borderRight: '1px solid #e5e5e5', padding: '16px', display: 'flex', flexDirection: 'column', gap: '8px' }}>
      ...
      <div style={{ flex: 1, padding: '24px', display: 'flex', flexDirection: 'column', gap: '16px' }}>
        <div style={{ height: '56px', background: 'white', margin: '-24px -24px 8px', borderBottom: '1px solid #e5e5e5' }} />
  ...
  return (
    <div style={{ display: 'flex', height: '100vh', background: '#f5f5f5', overflow: 'hidden' }}>
      ...
      <div style={{
        ...
        {/* Logo */}
        <div style={{ height: '60px', padding: '0 14px', display: 'flex', alignItems: 'center', gap: '10px', borderBottom: '1px solid #e5e5e5', flexShrink: 0 }}>
          {sidebarCollapsed ? (
        ...
        <nav style={{ flex: 1, overflowY: 'auto', overflowX: 'hidden', padding: '10px 8px' }}>
          {filteredNavSections.map(section => (
            <div key={section.title} style={{ marginBottom: '8px' }}>
              {!sidebarCollapsed && (
                <div style={{ color: '#bbb', fontSize: '10px', fontWeight: '700', textTransform: 'uppercase', letterSpacing: '0.08em', padding: '8px 10px 4px' }}>
                  {section.title}
                </div>
              )}
        ...
        <div style={{ padding: '10px 8px', borderTop: '1px solid #e5e5e5', flexShrink: 0 }}>
          {!sidebarCollapsed && profile && (
            <div style={{
              ...
              borderRadius: '10px', background: '#f9f9f9', marginBottom: '6px',
              cursor: 'pointer', border: '1px solid #e5e5e5', transition: 'all 0.2s'
            }}
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
            ...
            <div style={{ position: 'relative' }}>
              <button className="btn-icon" onClick={() => setShowNotifPanel(!showNotifPanel)} style={{ position: 'relative', color: '#666' }}>
                🔔
                {unreadCount > 0 && (
                  <span style={{ position: 'absolute', top: '0', right: '0', background: '#d71920', color: 'white', borderRadius: '50%', width: '16px', height: '16px', fontSize: '9px', fontWeight: '800', display: 'flex', alignItems: 'center', justifyContent: 'center', border: '2px solid white' }}>
              ...
              {showNotifPanel && (
                <div style={{ position: 'absolute', top: '48px', right: 0, width: '360px', background: 'white', border: '1px solid #e5e5e5', borderRadius: '16px', boxShadow: '0 8px 32px rgba(0,0,0,0.12)', zIndex: 1000, overflow: 'hidden', animation: 'slideDown 0.2s ease' }}>
                    ...
                    {notifications.length === 0 ? (
                      ...
                      notifications.map(notif => (
                        <div key={notif.id} onClick={() => markAsRead(notif.id)}
                          ...
                          <div style={{ width: '36px', height: '36px', borderRadius: '10px', background: notif.is_read ? '#f5f5f5' : 'rgba(215,25,32,0.08)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '18px', flexShrink: 0 }}>
                            {notificationIcon(notif.type)}
                          </div>
                          <div style={{ flex: 1, overflow: 'hidden' }}>
                            <div style={{ color: '#111', fontSize: '13px', fontWeight: notif.is_read ? '400' : '700', marginBottom: '2px' }}>{notif.title}</div>
                            {notif.body && <div style={{ color: '#888', fontSize: '12px', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>{notif.body}</div>}
      ...
      {showAdminPanel && profile?.role === 'admin' && (
        <div style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.6)', zIndex: 9999, display: 'flex', justifyContent: 'center', alignItems: 'center', padding: '20px', backdropFilter: 'blur(6px)' }}
          ...
          <div style={{ background: 'white', borderRadius: '20px', width: '100%', maxWidth: '680px', maxHeight: '88vh', overflowY: 'auto', border: '1px solid #e5e5e5', animation: 'bounceIn 0.3s ease', boxShadow: '0 24px 64px rgba(0,0,0,0.15)' }}
              ...
              <div style={{ background: '#f9f9f9', borderRadius: '12px', padding: '16px', marginBottom: '20px', border: '1px solid #e5e5e5' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(145px, 1fr))', gap: '8px' }}>
                  {[
                    ...
                    return (
                      <div key={mod.id} onClick={() => toggleAdminModule(mod.id)} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '10px 12px', borderRadius: '8px', cursor: 'pointer', background: isOn ? 'rgba(215,25,32,0.06)' : 'white', border: `1px solid ${isOn ? 'rgba(215,25,32,0.2)' : '#e5e5e5'}`, transition: 'all 0.2s' }}>
                        <span style={{ fontSize: '13px', color: isOn ? '#111' : '#999' }}>{mod.icon} {mod.label}</span>
                        <div style={{ width: '36px', height: '20px', borderRadius: '10px', background: isOn ? '#d71920' : '#e5e5e5', position: 'relative', flexShrink: 0, transition: 'background 0.2s' }}>
...
function ModuleToggle({ moduleId, role, onToggle, initialValue }) {
  ...
  return (
    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', background: enabled ? 'rgba(215,25,32,0.05)' : 'white', borderRadius: '8px', padding: '8px 10px', border: `1px solid ${enabled ? 'rgba(215,25,32,0.15)' : '#e5e5e5'}`, transition: 'all 0.2s', cursor: 'pointer' }}
      onClick={handleToggle}>
      <span style={{ color: enabled ? '#111' : '#999', fontSize: '12px' }}>{moduleLabels[moduleId] || moduleId}</span>
      <div style={{ width: '36px', height: '20px', borderRadius: '10px', background: enabled ? '#d71920' : '#e5e5e5', position: 'relative', flexShrink: 0, transition: 'background 0.2s' }}>
